...
export default function UnSettledPayinReport() {
    ...
    const BindPayinReport = async (data) => {
        try {
    ...
    return (
        <Box sx={{ width: '100%', maxWidth: { sm: '100%', md: '1700px' } }}>
            <div className="container mt-4">
                <h2 className="mb-4">UnSettled Payin Report</h2>
                <form className="row g-3" onSubmit={handleSubmit(BindPayinReport)} >
                    <div className="col-md-6">
                        <label>From Date</label>
                        <input type="datetime-local" className="form-control" {...register("startDate")} max={new Date().toISOString().split("T")[0]} />
                    </div>
                    <div className="col-md-6">
                        <label>To Date</label>
                        <input type="datetime-local" className="form-control" {...register("endDate")} max={new Date().toISOString().split("T")[0]} />
                    </div>
                    <div className="col-md-6">
                        <label>Search</label>
