...
import { GetsettledPayinLedger } from "../../services/SettledPayin";

export default function SettledLedgerPayinReport() {
    ...
    return (
        <Box sx={{ width: '100%', maxWidth: { sm: '100%', md: '1700px' } }}>
            <div className="container mt-4">
                <h2 className="mb-4">Settled Payin Ledger Report</h2>
