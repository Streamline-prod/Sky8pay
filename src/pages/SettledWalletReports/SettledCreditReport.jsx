...
export default function SettSettledCreditReport() {
    ...
    const BindSettledCreditReport = async (data) => {
        try {
    ...
    return (
        <Box sx={{ width: '100%', maxWidth: { sm: '100%', md: '1700px' } }}>
            <div className="container mt-4">
                <h2 className="mb-4">Settled Credit Report</h2>
                <form className="row g-3" onSubmit={handleSubmit(BindSettledCreditReport)} >
